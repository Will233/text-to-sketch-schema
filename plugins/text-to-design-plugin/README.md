...
- [Download](../../releases/latest/download/text-to-design-plugin.sketchplugin.zip) the latest release of the plugin
- Un-zip
- Double-click on text-to-design-plugin.sketchplugin
